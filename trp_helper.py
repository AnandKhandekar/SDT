...
def get_birds_eye_view_image(green_box, red_box,eye_view_height,eye_view_width):
    blank_image = cv2.imread('black_background.jpg')


    cv2.putText(blank_image, str(len(red_box)), (120,80), cv2.FONT_HERSHEY_SIMPLEX , 2, (0,0,255), 4, cv2.LINE_AA)
    cv2.putText(blank_image, str(len(green_box)), (320,80), cv2.FONT_HERSHEY_SIMPLEX , 2, (0,255,0), 4, cv2.LINE_AA)
